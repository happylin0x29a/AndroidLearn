...
public class BezierView3 extends View {
    ...
    private float mCircleRdius=200;// 圆的半径
    private float mDifference=mCircleRdius*C; //圆的控制点与数据点的差值
    private float[] mData=new float[8];//顺时针记录绘制圆形的4个数据点
    ...
    private void initPaint(){
        ...
        //初始化数据点
        mData[0]=0;
        mData[1]=mCircleRdius;
        mData[2]=mCircleRdius;
        mData[3]=0;
        mData[4]=0;
        mData[5]=-mCircleRdius;
        mData[6]=-mCircleRdius;
        mData[7]=0;
        //初始化控制点
